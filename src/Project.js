export default function Project() {
    return (
        <>
            <div class="sm:flex sm:justify-center max-w-sm w-full lg:max-w-full lg:flex h-150 mb-10 pt-5 pb-5 rounded-3xl border border-gray-400">
                <img class="inline-block" src="/class4989.png" alt="" width="350" height="auto" />
                <div class="ml-10 bg-white rounded-b lg:rounded-b-none lg:rounded-r p-4 flex flex-col justify-between leading-normal">
                    <div class="mb-8">
                        <div class="text-gray-900 font-bold text-3xl mb-2">CLASS 4989</div>
                    ...
                    <div class="ml-2 sm:flex sm:flex-col sm:justify-center">
            ...
            <div class="sm:flex sm:justify-center max-w-sm w-full lg:max-w-full lg:flex h-150 mb-10 pt-5 pb-5 rounded-3xl border border-gray-400">
                <img class="inline-block" src="/sortingbar.png" alt="" width="350" height="auto" />
                <div class="ml-10 bg-white rounded-b lg:rounded-b-none lg:rounded-r p-4 flex flex-col justify-between leading-normal">
                    <div class="mb-8">
                        <div class="text-gray-900 font-bold text-3xl mb-2">Sorting Bars</div>
                        <p class="text-black-700 text-lg text-base">
            ...
            <div class="sm:flex sm:justify-center max-w-sm w-full lg:max-w-full lg:flex h-150 mb-10 pt-5 pb-5 rounded-3xl border border-gray-400">
                <img class="inline-block" src="/myportfolio.png" alt="" width="350" height="auto" />
                <div class="ml-10 bg-white rounded-b lg:rounded-b-none lg:rounded-r p-4 flex flex-col justify-between leading-normal">
                    <div class="mb-8">
                        <div class="text-gray-900 font-bold text-3xl mb-2">Jihyun's Portfolio</div>
                        <p class="text-black-700 text-lg text-base">
